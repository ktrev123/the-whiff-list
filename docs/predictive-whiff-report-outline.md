...
> **Given an incoming pitch's location, count, and situational context, can we train a classification model to accurately estimate the probability of a hitter swinging and missing (whiffing), and how can we visually contextualize these high-risk pitch vectors for a non-baseball audience?**

This report shifts the analytical frame from grading what happened to forecasting what will happen.
